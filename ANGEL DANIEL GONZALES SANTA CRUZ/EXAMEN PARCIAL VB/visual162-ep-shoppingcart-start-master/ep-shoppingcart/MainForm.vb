Public Class MainForm
    ...
    Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        total_hombre = (n_hombres1 * 95) + (n_hombres2 * 85) + (n_hombres3 * 110)
        total_mujeres = (n_mujeres1 * 120) + (n_mujeres2 * 190) + (n_mujeres3 * 125)
        total_calzado = (n_calzado1 * 55) + (n_calzado2 * 80) + (n_calzado3 * 155)
        total_accesorios = (n_accesorios1 * 175) + (n_accesorios2 * 25)
        total_pagar = total_hombre + total_mujeres + total_calzado + total_accesorios
        lblTotal.Text = String.Format("${0:0}", total_pagar)
    End Sub
